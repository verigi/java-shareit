...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler(RequestAccessException.class)
    public ResponseEntity<String> handleRequestAccessException(RequestAccessException e) {
        log.error("Request access denied");
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
    }
